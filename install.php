...
function execute() 
{
	...
	$result = DBDo( $Query );
	if( !$result ) {
		echo TAB_LOCATIONS.' Not created <br>';
		$Errors++;
	}// if
	...
	$result = DBDo( $Query );
	if( !$result ) {
		echo TAB_GUESTBOOK.' Not created <br>';
		$Errors++;
	}// if
	...
	$result = DBDo( $Query );
	if( !$result ) {
		echo TAB_PICTURES.' Not created <br>';
		$Errors++;
	}// if
	...
	$result = DBDo( $Query );
	if( !$result ) {
		echo TAB_CONTENT.' Not created <br>';
		$Errors++;
	}// if
	...
	$result = DBDo( $Query );
	if( !$result ) {
		echo TAB_CONTENT.' content "setlist" not created <br>';
		$Errors++;
	}// if
	...
	$result = DBDo( $Query );
	if( !$result ) {
		echo TAB_SETTINGS.' Not created <br>';
		$Errors++;
	}// if
	...
	$result = DBDo( $Query );
	if( !$result ) {
		echo TAB_SETTINGS.' content "setlist" not created <br>';
		$Errors++;
	}// if
